  ...
  return (
    <div className='p-10'>
        ...
        {feedbackList&&feedbackList.map((item,index)=>(
          ...
          <CollapsibleTrigger className='p-2 bg-secondary rounded-lg my-2 text-left flex justify-between gap-7 font-bold w-full'>{item.question} <ChevronsUpDown className='h-5 w-5'/></CollapsibleTrigger>
          <CollapsibleContent>
